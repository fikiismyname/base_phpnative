<div class="col-md-12">
    <div class="c-card u-p-medium u-mb-medium">
        ...
        <div class="u-pt-medium u-text-center">
            <a target="_blank" class="u-text-mute u-text-small" href="https://example.com/<?= $_SESSION['username'] ?>">
                <i class="fa fa-globe u-mr-xsmall"></i>https://example.com/<?= $_SESSION['username'] ?>
            </a>
        </div>
    </div>
</div>